...
function MfeComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border rounded-lg bg-secondary text-secondary-foreground shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-4", children: "Micro App B (Next.js Hybrid)" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-4 text-muted-foreground", children: "This component is part of a Next.js app, but bundled via Vite for the Shell!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "destructive", onClick: () => setCount((c) => c + 1), children: [
      "App B Count: ",
      count
    ] }) })
  ] });
...
const mount = (container, props) => {
  ...
  root.render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MfeComponent, {}) })
  );
